...
def insertData():
    ...
    for ip in ip_list:
        try:
            ...
            sql = "INSERT INTO FARMSEYE_ENV (TEMP, HUMI, NO2, CO2, AIR_QUALITY, ILLUMI, TIMESTAMP) VALUES (%s, %s, %s, %s, %s, %s, %s)"
            cursor.execute(sql, (temp, pressure, NO2, CO2, airq, ldr_value, timestamp))
            conn.commit()
